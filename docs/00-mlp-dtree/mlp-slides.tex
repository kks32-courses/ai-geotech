...
\item $\alpha = 0.5$ /year (consolidation coefficient)
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figs/consolidation-tanh-fit.png}
	\caption*{Tanh activation fits consolidation curve smoothly}
\end{figure}

\textbf{Success:} 10 neurons sufficient for smooth approximation of bounded function.
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.9\textwidth]{figs/consolidation-width-comparison.png}
	\caption*{Consolidation approximation: 1, 5, 10, 20, 50 neurons}
\end{figure}

\textbf{Finding:} 10-20 neurons optimal. Diminishing returns beyond.
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figs/consolidation-activation-comparison.png}
	\caption*{Tanh naturally saturates at $S_{\text{final}} = 100$ mm}
\end{figure}

\textbf{Rule:} Bounded physical problems $\to$ Tanh/Sigmoid. Unbounded $\to$ ReLU.
...
\centering
\href{https://kks32-courses.github.io/ai-geotech/00-mlp-dtree/bce}{\beamergotobutton{BCE Demo}}
...
\textbf{Test on consolidation:} SGD vs Momentum vs Adam

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.95\textwidth]{figs/consolidation-optimizers.png}
	\caption*{Adam converges fastest, SGD slowest}
\end{figure}

\textbf{Recommendation:} Adam (lr=0.01) for most problems.
...
\begin{figure}[ht]
	...
	\caption*{Both work for smooth functions; Deep more parameter-efficient}
\end{figure}
...
\begin{itemize}
\item MSE < 2.0 mm$^2$
\item Smooth predictions over entire domain
\item Generalizes well to test data
\end{itemize}

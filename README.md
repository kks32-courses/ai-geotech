...
**Materials**
- Slides: [Handout: limitations of ML in geotechnics](docs/01-dtree/01-ml-limitations-handout.pdf)
...
- Notebook: [One API call](docs/07-llm/07a-llm-api-call.ipynb)
- Notebook: [RAG over geotechnical reports](docs/07-llm/07b-llm-rag-geotechnical.ipynb)
- Notebook: [Report-reading agent](docs/07-llm/07c-llm-report-agent.ipynb)
